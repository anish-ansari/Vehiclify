...
@section('dashboard-content')
    ...
    <form action="{{ URL::to('post-car-form') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="form-group">
            <label for="exampleInputEmail1"> Title </label>
            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter title" name="ctitle">
        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="cdescription" id="editor1"></textarea>
        </div>
